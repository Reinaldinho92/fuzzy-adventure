...
Search Signals is een online marketing bureau dat zich richt op het online transformeren en
groeien van B2B bedrijven. Wij werken voor B2B bedrijven in de servicebranch: van
accountantskantoren en machineproducenten tot product compliance en informatiebeveiliging.
...
/clients/
  [klantnaam]/
    client-info.md      → klantprofiel: branche, doelgroep, USPs, tone-of-voice
    briefings/
      [datum]-[campagne].md  → ingevuld briefing-template per opdracht
/shared/
...
- Klantdata staat altijd in /clients/[klantnaam]/. Lees client-info.md voordat je voor een klant werkt.
- Voeg een nieuwe klant toe door een submap aan te maken in /clients/ met een ingevuld client-info.md.
- Briefings per opdracht worden opgeslagen als /clients/[klantnaam]/briefings/[datum]-[campagne].md.
